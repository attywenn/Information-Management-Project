-- Make booking fully database-backed by storing the notification in Supabase inbox tables too.
...
begin
    ...
    values (
        ...
        'Appointment Booked',
        format(
            'Hello %s, your appointment for %s at %s has been saved. QR code: %s',
